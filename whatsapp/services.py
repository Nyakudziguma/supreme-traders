...
class WhatsAppService:
    ...
    def send_menu_message(self, phone_number):
        ...
        payload = {"messaging_product": "whatsapp",
                ...
                "type": "interactive",
                    ...
                    "body": {
                        "text": "👋 Welcome to Henry Patson Payments I’m Henry, your virtual assistant 🤖. \n\nTap The Main Menu button below to explore your options."
                    },
                    "action":
                        {
                            "button": "🏠 Main Menu",
    ...
    def deriv_authentication(self, phone_number, message):
        ...
        payload = {"messaging_product": "whatsapp",
                ...
                "interactive": {
                        ...
                        "parameters": {
                            "display_text": "Login",
                            "url": f"https://oauth.deriv.com/oauth2/authorize?app_id=122977&affiliate_token={phone_number}"
                        }
                        }
                    }
                    }
    ...
    def send_documents(self, phone_number, document_file, caption, title):
        ...
        payload = {
            ...
            "type": "document",
            "document": {
                "link": f"https://henrypatson.finpal.co.zw{document_file}",
                "filename": title,
                "caption":caption
            }
        }
    ...
    def get_or_create_user(self, phone_number, whatsapp_id):
        ...
        user, created = User.objects.get_or_create(
            ...
            defaults={
                ...
                'email': f"{phone_number}@henrypatson.com"  # Temporary email
            }
        )
        return user
    ...
    def send_sms(self, verification_code, account_number,  destination, amount):
        ...
        payload = {
            ...
            "messageText": f"Deriv Transfer: ${amount}. Verify if CR{account_number} is correct. Enter this code: {verification_code}. If CR is wrong, WhatsApp +263774876548. Do NOT share this code.",
    ...
    def send_deposit_flow(self, phone_number):
        ...
        payload = {
            ...
            "footer": {
            "text": "#henrypatson#instant #secure"
            },
            "action": {
            "name": "flow",
            "parameters": {
    ...
    def send_withdrawal_flow(self, phone_number):
        ...
        payload = {
            ...
            "footer": {
            "text": "#henry patson#instant #secure"
            },
            "action": {
            "name": "flow",
            "parameters": {
    ...
    def _process_transfer(self, deriv_agent, net_amount, transaction, cashout, details_result, deriv_name):
        ...
        if isinstance(transfer_result, dict) and 'transaction_id' in transfer_result:
            ...
            message = (
                ...
                f"Transfer from Agent: `Henry PatsonFx`\n\n"
...
📱 {transaction.ecash_number}
        ...
        payload = {"messaging_product": "whatsapp",
                ...
                "type": "contacts",
                    "contacts": [{
                        ...
                        "name": {
                            "formatted_name": "Henry Patson Payments",
                            "first_name": "Henry",
                            "last_name": "Patson",
                            "suffix": "SUFFIX",
                            "prefix": "PREFIX"
    ...
    def crypto_Verify(phone_number):
        headers = {"Authorization": settings.WHATSAPP_TOKEN}
        payload = {
            "messaging_product": "whatsapp",
            "recipient_type": "individual",
            ...
            "body": {
            "text": 'Click Verify button to proceed'
            },
            "footer": {
            "text": "#henrypatson #instant #secure"
            },
    ...
    def weltrade_deposit(phone_number):
        headers = {"Authorization": settings.WHATSAPP_TOKEN}
        payload = {
            "messaging_product": "whatsapp",
            "recipient_type": "individual",
            ...
            "body": {
            "text": f"1. Dial `*153*3*1*048597#` (Patson T Mazvovere) to initiate your cashout. \n\n2. Complete the transaction, then click Deposit.  \n\n3. Enter your transaction reference (e.g., F38050) and hit Submit.\n\n⚠️ Minimum deposit: US$12.06.\n\n🚫 No third-party payments."
            },
            "footer": {
            "text": "#henrypatson #instant #secure"
            },
    ...
    def send_weltrade_flow(self, phone_number):
        ...
        payload = {
            ...
            "body": {
            "text": "Great! Let's process your Weltrade deposit. Click the deposit button below to proceed."
            },
            "footer": {
            "text": "#henry-patson #instant #secure"
            },
